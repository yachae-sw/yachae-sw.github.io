...
```python
DESERIALIZED_IMAGE_PATH = os.path.join("output", "deserialized_image.png")
...
save_image(
    image = image,
    saveImagePath = DESERIALIZED_IMAGE_PATH,
    title=className
)
```
...
![result](https://user-images.githubusercontent.com/93850398/224556483-566ded04-fc6b-41d8-a0f5-b72f41c39942.png)
