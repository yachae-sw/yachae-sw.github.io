...
* section detection을 수행할 때 현재는 온몸의 구성 정모를 가장 유사하게 가지고 있는 L3 vertebral을 찾아서 추출하는 과정을 수행했습니다. 다른 연구에도 범용적으로 사용되려면 먼저 추적해야할 대상의 위치를 객체 검출(voloㄴ, r-cnn 등)을 통해 알아낸 뒤에 그 부분의 section을 추출해 낸다면 다른 연구에도 사용될 수 있지 않을까 생각됩니다.
